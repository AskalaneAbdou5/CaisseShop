            ...
            <input type="hidden" name="updatedDetailId" value="<?php echo $idProduit ?>">
                ...
                <div class="form-ligne-haute">
                    ...
                    <div class="form-colonne-gauche">
                        ...
                        <div class="champ">
                            ...
                            <input type="number" id="priceValue" step="0.01" name="updatedDetailPrix" min="0" placeholder="Ex : 2.5" value="<?php echo $prixProduit ?>">
                        </div>
                    </div>
                ...
                <div class="form-ligne">
                    <div class="champ">
                        ...
                        <input class="input" type="number" id="stockProduit" min="0" name="updatedDetailStock" placeholder="Ex : 200" value="<?php echo $stockProduit ?>">
                    </div>
                    <div class="champ">
